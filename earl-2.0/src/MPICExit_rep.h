...
#ifndef EARL_MPICEXIT_REP_H
#define EARL_MPICEXIT_REP_H
...
namespace earl
{
  ...
  public:
    ...
    virtual etype       get_type()    const { return MPICEXIT; }
    virtual std::string get_typestr() const { return "MPICEXIT"; }
