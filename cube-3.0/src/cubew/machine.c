...
void cube_machine_writeXML(cube_machine* this, FILE* fp) {
  ...
  char * _name  = (char *)services_escape_to_xml(cube_machine_get_name(this));
  char * _descr = (char *)services_escape_to_xml(cube_machine_get_desc(this));
