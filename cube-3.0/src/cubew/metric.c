...
void cube_metric_writeXML(cube_metric* this, FILE* fp) {
  ...
  char * _disp_name   = (char *)services_escape_to_xml(cube_metric_get_disp_name(this));
  char * _uniq_name   = (char *)services_escape_to_xml(cube_metric_get_uniq_name(this));
  char * _dtype       = (char *)services_escape_to_xml(cube_metric_get_dtype(this));
  char * _uom         = (char *)services_escape_to_xml(cube_metric_get_uom(this));
  char * _val         = (char *)services_escape_to_xml(cube_metric_get_val(this));
  char * _url         = (char *)services_escape_to_xml(cube_metric_get_url(this));
  char * _descr       = (char *)services_escape_to_xml(cube_metric_get_descr(this));
  ...
  if (_disp_name) free(_disp_name);
  if (_uniq_name) free(_uniq_name);
  if (_dtype) free(_dtype);
  if (_uom) free(_uom);
  if (_val) free(_val);
  if (_url) free(_url);
